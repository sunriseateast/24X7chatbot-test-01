        ...
        (
          <PopoverContent className="flex flex-col border border-[#3C3D37] drop-shadow bg-[#303030] w-[190px] translate-y-[10px] -translate-x-[20px] rounded-xl p-[5px]">
            <div onClick={()=>{
              setNodes([])
              rmallNodes()
            }} className="flex space-x-[2px] hover:bg-[rgb(255,255,255,0.1)] rounded-lg p-[5px] cursor-pointer">
              ...
              <span className="select-none text-slate-50 text-center text-[14px] font-semibold mb-[4px]">Delete messages</span>
            </div>


            <div onClick={()=>setEdges([])} className="flex space-x-[2px] items-center  hover:bg-[rgb(255,255,255,0.1)] rounded-lg p-[5px] cursor-pointer">
              <div className="flex items-center relative px-[5px]">
                 <div className="text-zinc-400 h-[17px] w-[17px] flex items-center justify-center">
                  <Connection/>
                </div>
              ...
              <span className="select-none text-slate-50 text-center mb-[4px] text-[14px] font-semibold">Delete links</span>
            </div>
          </PopoverContent>
        )
      }
