      ...
      {logedIn ? (
        <div className="flex items-center gap-x-9 cursor-pointer hover:bg-[rgb(255,255,255,0.1)] rounded-lg h-full w-full p-[5px]">
          <div className="flex gap-x-3 items-center justify-center">
            ...
            <div className="text-slate-50">
              ...
              <div className="bg-[#303030]  rounded flex items-center justify-center space-x-[2px]">
                ...
                <span className="select-none text-[12px] text-center text-muted-foreground font-semibold">
                  connected
                </span>
              </div>
            </div>
          ...
          <div>
            <DropdownMenu>
              <DropdownMenuTrigger>
                <div className="hover:text-red-500 text-[12px] bg-slate-100 rounded p-[5px] cursor-pointer">
                  remove
                </div>
              </DropdownMenuTrigger>
              ...
              <DropdownMenuContent
                side="right"
                align="start"
                className={`border border-[#3C3D37] drop-shadow bg-[#303030]`}
              >
                <div className="select-none p-[5px] text-[12px] text-muted-foreground">
                  <div className="flex items-center">
                    <span className="group underline text-muted-foreground font-semibold">
                      Open{" "}
        ...
        <div className="p-[5px] relative">
          <div className="business-login flex items-center justify-center gap-x-2 font-semibold cursor-pointer bg-slate-50 p-[10px] text-[12px] rounded-lg">
            ...
            <p className="text-center">Login with existing account</p>
